  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-white hover:opacity-90 shadow-glow transition-bounce",
        wingstop: "gradient-wingstop text-white hover:opacity-90 shadow-glow",
        panda: "gradient-panda text-white hover:opacity-90 shadow-glow",
        rubios: "gradient-rubios text-white hover:opacity-90 shadow-glow",
        blaze: "gradient-blaze text-white hover:opacity-90 shadow-glow",
      },
      size: {
